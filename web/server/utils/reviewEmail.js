  ...
  const body = isSuccess
    ? `
      <div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif; max-width: 400px; margin: 0 auto; padding: 40px 20px;">
        ...
        <p style="color: #78716c; font-size: 13px; margin: 0;">This review will be available for 7 days.</p>
      </div>
    `
    : `
      <div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif; max-width: 400px; margin: 0 auto; padding: 40px 20px;"><p style="color: #44403c; font-size: 15px; margin: 0 0 16px;">We couldn't complete the review of your document. This may occasionally happen if the server or LLM providers are busy, or  when you have uploaded non-research content. Please try again in a few minutes. If the problem persists, please contact support at support@shoulde.rs.</p><a href="${getBaseUrl()}/review" style="display: inline-block; background: #1c1917; color: #ffffff; padding: 10px 24px; border-radius: 6px; text-decoration: none; font-size: 14px; font-weight: 500; margin: 8px 0 24px;">Try Again</a>
      </div>
    `
